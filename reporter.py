...
class DecisionReporter:
    ...
    def save(self, decision: AllocationDecision, candidates: List[Dict[str, Any]], missing_data: List[str], portfolio_decision: Any | None = None, source_attribution: Dict[str, str] | None = None) -> Dict[str, Path]:
        ...
        report_path.write_text(self.render_markdown(decision, candidates, missing_data, portfolio_decision, source_attribution), encoding="utf-8")
        return {"report": report_path, "history": self.history_path}

    def render_markdown(self, decision: AllocationDecision, candidates: List[Dict[str, Any]], missing_data: List[str], portfolio_decision: Any | None = None, source_attribution: Dict[str, str] | None = None) -> str:
